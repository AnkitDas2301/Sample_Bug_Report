...
Player Camp (multiple camp locations observed) 

 

Bug Type 

Gameplay / Player Control / AI (Horse) 
...
Horse is set as the primary mount 
...
Fast travel to the current player camp 

Approach the player’s primary horse 
...
Player cannot steer or move the horse 

Horse remains stationary despite stamina and controls being active 
